...
# ââ random quote bank ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
QUOTES=(
...
# pick one based on the current minute (so it changes but isn't truly random)
IDX=$(( $(date +%M%S) % ${#QUOTES[@]} ))
QUOTE="${QUOTES[$IDX]}"

# ââ date greeting âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
HOUR=$(date +%H)
...
# ââ print welcome âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
echo ""
_sp_color $MAG; echo "   $GREET, $(whoami)! Welcome to Sir Prize Linux."; _sp_color $RST
_sp_color $CYN; echo "  $(date '+%A, %B %-d %Y  â¢  %H:%M')"; _sp_color $RST
echo ""
_sp_color $YLW; echo "  $QUOTE"; _sp_color $RST
echo ""

# ââ first-ever login surprise âââââââââââââââââââââââââââââââââââââââââââââââââ
...
if [[ ! -f "$STAMP" ]]; then
  ...
  â                                                          â
  â     CONGRATULATIONS! You've opened the box!          â
  â                                                          â
